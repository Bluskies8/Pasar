...
<section class="login-clean container">
    <form method="post" action='/clogin'>
        ...
        <div class="illustration"><img class="w-100" src="{{asset('img/logo.jpeg')}}"></div>
        <div style="padding: 0px 40px 40px 40px;">
            <div class="mb-3"><input class="form-control" type="text" name="email" placeholder="Masukan Username"></div>
