            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between">
                    <div class="position-relative">
                        <input type="datetime-local" class="form-control" id="input-shif-masuk" style="width: 200px;" />
                    ...
                    <div class="position-relative">
                        <input type="datetime-local" class="form-control" id="input-shif-keluar" style="width: 200px;" />
