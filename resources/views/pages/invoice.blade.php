                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-invoice-detail">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td class="text-end w-75" colspan="6">Dibayarkan</td>
